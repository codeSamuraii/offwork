"""Stress-test offwork with a multi-file module (47 nodes, 3 classes, 7 files).
...
from offwork import Graph, pack, reconstruct, serialize
...
# ── Phase 1: module works without offwork ─────────────────────────────
