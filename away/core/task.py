...
from away.core.signing import verify_signature, compute_signature
...
class _TaskEncoder(json.JSONEncoder):
    """JSON encoder that pre-walks the tree to apply away sentinels.
...
class Task:
    ...
    of away internals to dispatch work.
    ...
    def from_json(
        ...
        *,
        ...
        signing_key
            ...
            :class:`~away.core.errors.SignatureError` is raised.
