...
class Error(Exception):
    """Raised when away cannot trace or analyze a function."""
...
if sys.excepthook is not _away_excepthook:
    sys.excepthook = _away_excepthook
