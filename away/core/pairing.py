...
from away.core.errors import PairingError

logger = logging.getLogger(__name__)

# Fixed salt used to bind the PIN derivation to away
_PIN_SALT = b"away-pairing-v1"
...
async def initiate_pairing(
    ...
    ----------
    backend
        A away :class:`~away.worker.backends.base.Backend` instance
