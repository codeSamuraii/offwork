...
from away.worker.deps import ensure_dependencies
...
class Worker:
    """Execute functions from serialized away graphs with caching.
    ...
    sandbox
        Optional :class:`~away.worker.sandbox.DockerSandbox` or
    ...
    async def _build(
        ...
        code = compile(source, f"<away:{function_name}>", "exec")
        namespace: dict[str, Any] = {}
...
async def execute(
    ...
    **kwargs: Any,
    ...
    """One-shot execution of a function from a serialized away graph.
