...
from pyfuse.core.errors import DependencyError, WorkerOnlyError
...
def worker_only_import(package: str | None = None) -> Iterator[None]:
    ...
    Example::
        ...
        with pyfuse.worker_only_import():
            import requests

        with pyfuse.worker_only_import("opencv-python-headless"):
            import cv2
