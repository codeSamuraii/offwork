...
class RedisBackend(Backend):
    ...
    DEFAULT_QUEUE_KEY = "seeya:tasks"
    RESULT_PREFIX = "seeya:result:"
    HEARTBEAT_PREFIX = "seeya:heartbeat:"
    CANCEL_PREFIX = "seeya:cancel:"
    PROGRESS_PREFIX = "seeya:progress:"
    SCHEDULE_PREFIX = "seeya:schedule:"
    THROTTLE_PREFIX = "seeya:throttle:"
    NOTIFY_CHANNEL = "seeya:notify"
