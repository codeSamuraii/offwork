...
from seeya.worker.deps import ensure_dependencies
...
class Worker:
    """Execute functions from serialized seeya graphs with caching.
    ...
    sandbox
        Optional :class:`~seeya.worker.sandbox.DockerSandbox` or
    ...
    async def _build(
        ...
        code = compile(source, f"<seeya:{function_name}>", "exec")
        namespace: dict[str, Any] = {}
...
async def execute(
    ...
    **kwargs: Any,
    ...
    """One-shot execution of a function from a serialized seeya graph.
