...
from seeya.core.signing import verify_signature, compute_signature
...
class _TaskEncoder(json.JSONEncoder):
    """JSON encoder that pre-walks the tree to apply seeya sentinels.
...
class Task:
    ...
    of seeya internals to dispatch work.
    ...
    def from_json(
        ...
        *,
        ...
        signing_key
            ...
            :class:`~seeya.core.errors.SignatureError` is raised.
