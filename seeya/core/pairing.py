...
from seeya.core.errors import PairingError

logger = logging.getLogger(__name__)

# Fixed salt used to bind the PIN derivation to seeya
_PIN_SALT = b"seeya-pairing-v1"
...
_PAIRING_CHANNEL = "seeya:pairing"
...
async def initiate_pairing(
    ...
    ----------
    backend
        A seeya :class:`~seeya.worker.backends.base.Backend` instance
