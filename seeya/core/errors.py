...
class Error(Exception):
    """Raised when seeya cannot trace or analyze a function."""
...
if sys.excepthook is not _seeya_excepthook:
    sys.excepthook = _seeya_excepthook
